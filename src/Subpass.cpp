...
namespace vg
{
    Subpass::Subpass(
        ...
        const std::optional<AttachmentReference>& depthStencilAttachment,
        const std::vector<uint32_t>& preserveAttachments)
        :graphicsPipeline(std::move(graphicsPipeline)), inputAttachments(inputAttachments), colorAttachments(colorAttachments), resolveAttachments(resolveAttachments), depthStencilAttachment(depthStencilAttachment), preserveAttachments(preserveAttachments)
    {}
    ...
    Subpass::Subpass(
        ...
        :graphicsPipeline(std::move(graphicsPipeline)), inputAttachments(std::move(inputAttachments)), colorAttachments(std::move(colorAttachments)), resolveAttachments(std::move(resolveAttachments)), depthStencilAttachment(depthStencilAttachment), preserveAttachments(std::move(preserveAttachments))
    {}
