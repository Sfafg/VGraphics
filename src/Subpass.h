...
struct Subpass {
     ...
     * @param colorAttachments Array of color attachments must be same size as Resolve and DepthStencil atachments if
     * are not null
     * @param resolveAttachments Array of resolve attachments must be same size as Color and DepthStencil atachments if
     * are not null
